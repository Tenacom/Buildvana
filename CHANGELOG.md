...
- The [`NuGetPack` module](docs/sdk-modules/nuget-pack.md#readme) finds the README file that `PackageReadmeFile` names, where it used to look up the name that `PackageLicenseFile` holds and raise [BVSDK1510](docs/sdk-diagnostics.md#nugetpack-module-1500-1599).
...
- The [`SourceGenerators` module](docs/sdk-modules/source-generators.md) raises [BVSDK1100 and BVSDK1101](docs/sdk-diagnostics.md#source-generators-1100-1199), where `BV_CheckRoslynVersion` declared them inside an `ItemGroup` and neither ever fired.
...
- The [`XmlDocumentation` module](docs/sdk-modules/xml-documentation.md#xmldocs-property) defaults `XmlDocs` to `false` when a project sets `GenerateDocumentationFile` to `false`, where such a library project got SA0001 from StyleCop.
