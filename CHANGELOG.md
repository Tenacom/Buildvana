...
- The `XmlDocumentation` module defaults `XmlDocs` to `false` when a project sets `GenerateDocumentationFile` to `false`, where such a library project got SA0001 from StyleCop.
