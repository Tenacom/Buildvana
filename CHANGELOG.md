...
- **BREAKING CHANGE**: The `JetBrainsAnnotations` module no longer exports the annotations of a [Visual Basic project](docs/sdk-modules/jetbrains-annotations.md#migration-to-exportjetbrainsannotations).
...
- **BREAKING CHANGE**: `UseNerdbankGitVersioning` gives way to [`UseVersioning`](docs/sdk-modules/versioning.md#useversioning-property), and a project that still sets it gets warning BVSDK2001.
