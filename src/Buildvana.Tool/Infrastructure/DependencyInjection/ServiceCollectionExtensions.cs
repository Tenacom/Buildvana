    ...
    extension(IServiceCollection @this)
    {
        ...
        public IServiceCollection AddBvServices()
        {
            _ = @this
                ...
                .AddSingleton<PackagePinWriter>()
                .AddSingleton<ToolPinUpdater>()
                .AddSingleton<SdkPinWriter>()
                .AddSingleton<NetSdkPinWriter>()
                .AddSingleton<DependencyApplier>()
                .AddSingleton<IDependencyRestorer>(static sp => sp.GetRequiredService<DotNetService>())
                .AddSingleton<IVulnerabilityDataSource, NuGetVulnerabilityDataSource>()
