...
public sealed class DotNetService
{
    ...
    /// <para>To merge coverage reports, this method requires the <c>dotnet-reportgenerator-globaltool</c> .NET CLI tool to be installed.</para>
    /// </remarks>
    public void TestSolution(bool restore, bool build, bool collect)
    {
        ...
        if (collect)
        {
            ...
            else
            {
                ...
                _context.DotNetTool($"reportgenerator \"-reports:{reports}\" \"-targetDir:{_paths.TestResults}\" -reporttypes:Cobertura");
            }
        }
    }
