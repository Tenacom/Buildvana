...
/// the member name: it lands in the keyed object's <c>propertyNames</c>. On the value property it describes
/// the member value, and lands in <c>additionalProperties</c>.</para>
/// </remarks>
