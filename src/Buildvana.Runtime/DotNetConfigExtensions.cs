...
/// <summary>
/// Provides extension methods for `DotNetConfig` instances.
/// </summary>
/// <remarks>
/// <para>The receiver is nullable because a configuration file may omit the <c>dotnet</c> section entirely:
...
{
    extension(DotNetConfig? @this)
    {
        /// <summary>
        /// Gets the build configuration to pass to <c>dotnet</c>: <see cref="DotNetConfig.Configuration"/>,
        /// or <see cref="DotNetConfig.DefaultConfiguration"/> when the configuration file does not set it.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public string EffectiveConfiguration => @this?.Configuration ?? DotNetConfig.DefaultConfiguration;
    }
}
