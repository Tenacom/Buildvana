...
partial class BuildHostExtensions
{
    extension(IBuildHost @this)
    {
        ...
        public void LogWarning(string message) => @this.Log(LogLevel.Warning, message);
        ...
        public void LogWarning(
            ...
            => @this.Log(LogLevel.Warning, string.Format(CultureInfo.InvariantCulture, format, args));
    }
}
