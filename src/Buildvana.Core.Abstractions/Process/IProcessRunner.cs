...
public interface IProcessRunner
{
    ...
    /// <param name="throwOnNonZero">If <see langword="true"/> (the default), the build is failed via <see cref="IBuildHost.Fail"/> when the process exits with a non-zero exit code; if <see langword="false"/>, the result is returned regardless of exit code.</param>
