...
| `release.branches`                    | none                            | The regular expressions of the branches that produce [public releases](sdk-modules/versioning.md#releasebranches-setting), and by default no branch does.            |
...
| `fileBasedApps`                       | none                            | Gitignore-syntax patterns naming the [file-based apps](tool-commands/dependencies.md#file-based-apps) of the repository, and the hooks directory is always included. |
