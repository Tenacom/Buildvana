...
| `RuntimeInfo.DelegatingVersion`  | string or null | The version of the `bv` that [delegated](directory-structure.md#configdotnet-toolsjson) the run to the pinned version, or `null` when the run was not delegated.     |
