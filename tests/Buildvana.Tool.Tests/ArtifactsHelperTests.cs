...
internal sealed class ArtifactsHelperTests
{
    [Test]
    public async Task DiscoverProducedPackages_WithoutArtifactsDirectory_ReturnsEmpty()
    {
        ...
        var result = ArtifactsHelper.DiscoverProducedPackages(missingPath, "1.0.0");
    ...
    public async Task DiscoverProducedPackages_MapsMatchingPackagesAndIgnoresOthers()
    {
        ...
        var result = ArtifactsHelper.DiscoverProducedPackages(home.RootPath, "2.0.0");
    ...
    public async Task DiscoverProducedPackages_MatchesVersionSuffixCaseInsensitively()
    {
        ...
        var result = ArtifactsHelper.DiscoverProducedPackages(home.RootPath, "2.0.0-preview");
